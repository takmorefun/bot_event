...
if __name__ == "__main__":
    ...
    #botの初期化
    MA_bot = moving_average(key, secret, line_token)
    
    #パラメーターを調整(使用するローソク足)
    MA_bot.candleTerm = "5T"
    MA_bot.number = 300
    MA_bot.period = "300"
